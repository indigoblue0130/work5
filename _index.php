...
// ユーザーがログインしていない場合は、login.htmlにリダイレクト
...
<div class="header-topbar">
  ...
  <div class="user-menu">
    ...
    <div id="main">
        <!-- 画像をレスポンシブに対応させる -->
        <picture>
            <source media="(max width: 600px)" srcset="./img/main3.jpg"/>
    ...
    <section id="about" class="wrapper">
        ...
        <p><a href="view_pdf.php?file=kaigi_202411_2.pdf">＜新体制スローガン＞ 成長エンジン＆成長ドライバー</a></p>
    ...
    <H2 class="sec-title">SPIKA</H2>
        <ul>
            <li>
                <a href="view_pdf.php?file=SPIKA202601.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/cup4.jpg" alt="works1">
                        <p>SPIKA/NPS分析(11-1月)</p>
                </a>
            </li>  
            <li>
    ...
    <section id="tenken" class="wrapper">
        <H2 class="sec-title">contact（準備中）</H2>
            <div class="archive">
    ...
    <section id="works" class="wrapper">
        ...
        <ul>
            <li>
                <a href="view_pdf.php?file=sokuho_2025.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/works1.jpg" alt="works1">
                        <p>受注登録売上速報</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=basic_1.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/pc1.jpg" alt="works1">
                        <p>L-MAX/基本活動</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=hoken.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/works3.jpg" alt="works1">
                        <p>保険獲得&継続率</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=attack_6m.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/iPhone2.jpg" alt="works1">
                        <p>アタックリスト状況</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=shinki.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/cycle1.jpg" alt="works1">
                        <p>新規フォロー状況</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=ei_zangyo.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/suisho3.jpg" alt="works1">
                        <p>営業S残業時間</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=service_rieki.pdf" target="_blank" class="image-container">    
                    <img src="./assets/img/works4.jpg" alt="works1">
                        <p>サービス実績表</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=jishiritu2.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/works5.jpg" alt="works1">
                        <p>車点検実施率[予測]</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=jishiritu.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/pc9.jpg" alt="works1">
                        <p>車点検実施率[実績]</p>
                </a>
            </li>    
            <li>
                <a href="view_pdf.php?file=chao_mijishi.pdf" target="_blank" class="image-container">    
                    <img src="./assets/img/works6.jpg" alt="works1">
                        <p>まかせチャオ消化率</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=chao_yoyaku.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/iPhone1.jpg" alt="works1">
                        <p>サービス翌月予約確認</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=SE_zangyo.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/suisho2.jpg" alt="works1">
                        <p>SE残業時間</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=SE_result.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/works2.jpg" alt="works1">
                        <p>SE別実績表</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=service_add.pdf" target="_blank" class="image-container">
                    <img src="./assets/img/pc5.jpg" alt="works1">
                        <p>サービス付加価値</p>
                </a>
            </li>
            <li>
                <a href="view_pdf.php?file=revenue.pdf" target="_blank" class="image-container">
    ...
    <div class="archive">
        <a href="view_pdf.php?file=keikakusho2025.pdf">
        ...
        <a href="view_pdf.php?file=graph2025.pdf">
            <img src="./assets/img/graph2025.png" alt="archive">
        </a>
        <a href="view_pdf.php?file=新車納車説明スタンダード.pdf">
        ...
        <a href="view_pdf.php?file=keiriTips_07.pdf">
        ...
        <!-- <a href="view_pdf.php?file=teikinri.pdf">
            <img src="./assets/img/teikinri.jpg" alt="archive">
        </a>
        <a href="view_pdf.php?file=SW_30.pdf">
            <img src="./assets/img/SW_30MIN.jpg" alt="archive">
        </a> -->
    </div>
    </section>
    <!-- news -->
    <section id="news" class="wrapper">
        ...
        <dl>
            ...
            <dt>2025/3/3</dt>
            <dd>社内TOPS優勝スタッフの動画を追加しました。</dd>
            <dt>2025/3/6</dt>
            <dd>拠点別年間登録実績グラフを毎日更新に変更しました。</dd>
            <dt>2025/4/6</dt>
            <dd>SPIKA(3月コメント/下期分析)を更新しました。</dd>
        </dl>
    </section>
    <!-- <section id="SPIKA" class="wrapper">
    <H2 class="sec-title">SPIKA</H2>
